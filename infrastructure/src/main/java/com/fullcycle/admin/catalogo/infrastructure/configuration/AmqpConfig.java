...
import com.fullcycle.admin.catalogo.infrastructure.configuration.properties.QueueProperties;
...
public class AmqpConfig {
    ...
    static class Admin {
        ...
        @Bean
        @VideoCreatedQueue
        public Binding videoCreatedBinding(@VideoEvents DirectExchange exchange,
        ...
        @Bean
        @VideoEncodedQueue
        public Binding videoEncodedBinding(@VideoEvents DirectExchange exchange,
