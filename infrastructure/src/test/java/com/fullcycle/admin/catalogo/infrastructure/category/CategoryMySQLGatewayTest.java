...
public class CategoryMySQLGatewayTest {
    ...
    public void givenAValidCategory_whenCallsCreate_shouldReturnANewCategory() {
        ...
        final var expectedIsAlive = true;

        final var aCategory = Category.newCategory(expectedName, expectedDescription, expectedIsAlive);
        ...
        Assertions.assertEquals(expectedIsAlive, actualCategory.isActive());
        ...
        Assertions.assertEquals(expectedIsAlive, actualEntity.isActive());
    ...
    public void givenAValidCategory_whenCallsUpdate_shouldReturnCategoryUpdated() {
        ...
        final var aCategory = Category.newCategory("Film", null, expectedIsAlive);
        ...
        Assertions.assertEquals(expectedIsAlive, actualInvalidEntity.isActive());

        final var aUpdatedCategory = aCategory.clone().update(expectedName, expectedDescription, expectedIsAlive);
    ...
    public void givenPrePersistedCategories_whenCallsFindAll_shouldReturnPaginated() {
        ...
        categoryRepository.saveAll(List.of(CategoryJpaEntity.from(filmes), CategoryJpaEntity.from(series),
