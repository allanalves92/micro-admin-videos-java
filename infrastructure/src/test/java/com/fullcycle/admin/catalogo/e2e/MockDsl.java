...
public interface MockDsl {
    ...
    default ResultActions deleteACategory(final Identifier anId)
            throws Exception {
    ...
    default ResultActions deleteAGenre(final Identifier anId)
            throws Exception {
    ...
    private String given(final String url, final Object body)
            throws Exception {
