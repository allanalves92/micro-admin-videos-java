...
public class GenreAPITest {
    ...
    public void givenAValidCommand_whenCallsCreateGenre_shouldReturnGenreId() throws Exception {
        ...
        //When
        final var request = post("/genres").contentType(MediaType.APPLICATION_JSON)
    ...
    public void givenAnInvalidName_whenCallsCreateGenre_thenShouldReturnNotification() throws Exception {
        ...
        when(createGenreUseCase.execute(any())).thenThrow(
    ...
    public void givenAValidId_whenCallsGetGenreById_shouldReturnGenre() throws Exception {
        ...
        final var aGenre =
                Genre.newGenre(expectedName, expectedIsActive).addCategories(expectedCategories.stream().map(
    ...
    @Test
    public void givenAnInvalidID_whenCallsUpdateGenre_shouldReturnNotFoundException() throws Exception {
        //Given
        final var expectedId = "not_found";
        final var expectedName = "Ação";
        final var expectedCategories = List.of("123", "456");
        final var expectedIsActive = true;
        final var expectedErrorMessage = "Genre with ID not_found was not found";

        final var aCommand = new UpdateGenreRequest(expectedName, expectedCategories, expectedIsActive);

        when(updateGenreUseCase.execute(any())).thenThrow(
                NotFoundException.with(Genre.class, GenreID.from(expectedId)));
    ...
    @Test
    public void givenAInvalidName_whenCallsUpdateGenre_thenShouldReturnNotifcation() throws Exception {
        //Given
        final String expectedName = null;
        final var expectedCategories = List.of("123", "456");
        final var expectedIsActive = true;
    ...
    public void givenValidParams_whenCallsListGenres_shouldReturnGenres() throws Exception {
        ...
        when(listGenreUseCase.execute(any())).thenReturn(
        ...
        verify(listGenreUseCase, times(1)).execute(
                argThat(query ->
