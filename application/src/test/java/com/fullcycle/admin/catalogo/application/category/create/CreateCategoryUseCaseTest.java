...
public class CreateCategoryUseCaseTest {
    ...
    public void givenAValidCommand_whenCallsCreateCategory_shouldReturnCategoryId() {
        ...
        Mockito.verify(categoryGateway, times(1)).create(argThat(aCategory -> Objects.equals(expectedName,
                aCategory.getName()) && Objects.equals(expectedDescription, aCategory.getDescription()) &&
